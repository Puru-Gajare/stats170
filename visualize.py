...
fig.suptitle("Linear Regression — California Housing Prices",
...
ax_metrics.axis("off")
cards = [
    ("R² Score",  f"{metrics['r2']:.3f}",  "explains 64% of price variance"),
    ("RMSE",      f"${metrics['rmse']:,}",  "avg prediction error"),
    ("MAE",       f"${metrics['mae']:,}",   "median absolute error"),
]
...
plt.savefig("housing_regression_plots.png", dpi=150, bbox_inches="tight")
print("Saved housing_regression_plots.png")
plt.show()
